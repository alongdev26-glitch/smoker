...
(function (global) {
  const PATHS = {
    ...
    chart: '<polyline points="2,18 6,10 10,15 14,7 18,12 22,4"/><circle cx="2" cy="18" r="1.3" fill="currentColor" stroke="none"/><circle cx="6" cy="10" r="1.3" fill="currentColor" stroke="none"/><circle cx="10" cy="15" r="1.3" fill="currentColor" stroke="none"/><circle cx="14" cy="7" r="1.3" fill="currentColor" stroke="none"/><circle cx="18" cy="12" r="1.3" fill="currentColor" stroke="none"/><circle cx="22" cy="4" r="1.3" fill="currentColor" stroke="none"/>',
    ...
    'eye-off': '<path d="M3 3l18 18"/><path d="M10.6 5.2A10.4 10.4 0 0 1 12 5c6.4 0 10 7 10 7a17 17 0 0 1-3.4 4.3M6.5 6.6C4 8.3 2 12 2 12s3.6 7 10 7c1.4 0 2.6-.3 3.7-.8"/><path d="M9.9 9.9a3 3 0 0 0 4.2 4.2"/>'
  };
